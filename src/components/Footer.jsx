...
const Footer = () => {
  return (
    <div className='w-full bg-zinc-900 p-20 h-screen flex  '>
        <div className='w-1/2 flex flex-col justify-between h-full'>
            <div className="heading">
            <h1 className='text-8xl font-["Founders_Grotesk_Condensed"] font-semibold leading-none tracking-tighter '>EYE-</h1>
            <h1 className='text-8xl font-["Founders_Grotesk_Condensed"] font-semibold leading-none tracking-tighter -mt-5'>OPENING</h1>
        </div>
        <svg  width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className='text-8xl font-["Founders_Grotesk_Condensed"] font-semibold leading-none tracking-tighter '>PRESENTATIONS</h1>
             <div className="anchord flex flex-col gap-10">
                <a  className='text-3xl leading-none tracking-tighter ' href="">linkedin</a>
                <a className='text-3xl leading-none tracking-tighter ' href="">github</a>
                <a  className='text-3xl leading-none tracking-tighter 'href="">discord</a>
             </div>
                                </div>
    </div>
  )
